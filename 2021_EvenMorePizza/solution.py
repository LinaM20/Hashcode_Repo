def deliveries(pizzaAmount, teamTwo, teamThree, teamFour, the_pizza_dict):
    ...
    for pizza in the_pizza_dict.values():
        # delivering to teams of 2 
        while numPizza < two_team_total:
            order_list1.append(the_pizza_dict[numPizza]) 
    ...
    with open("C:\\Users\\Windows\\Desktop\\CS\\HASHCODE\\Practice\\example.out", "w", encoding='utf8') as outputfile: # unicode transformation formatos xx
...
def main():
    ...
    fp = open("C:\\Users\\Windows\\Desktop\\CS\\HASHCODE\\Practice\\a_example", "r") 
    details = []
    counter = 0
    ...
    with open("C:\\Users\\Windows\\Desktop\\CS\\HASHCODE\\Practice\\a_example", "r") as file: 
